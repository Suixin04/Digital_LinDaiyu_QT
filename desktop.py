...
from digital_lindaiyu.config import env_flag, get_gpt_sovits_config, get_tts_config
...
def _ask_enable_tts() -> bool:
    if "DIGITAL_LDY_ENABLE_TTS" in os.environ:
        return env_flag("DIGITAL_LDY_ENABLE_TTS", True)
    return (
